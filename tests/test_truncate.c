...
START_TEST(test_truncate_positive_fraction) {
  ...
  s21_decimal out;
  int result = s21_truncate(in, &out);
...
START_TEST(test_truncate_null_result) {
  ...
  int result = s21_truncate(in, NULL);
...
START_TEST(test_truncate_large_high_bits) {
...
Suite *s21_truncate_suite(void) {
  ...
  tcase_add_test(tc_core, test_truncate_large_high_bits);
